...
<body>
	...
	<%@ include file="/WEB-INF/views/nav.jsp" %>
      ...
      <div class="col-md-9" style="margin-top: 100px; width: 65%">
      	<button type="button" class="btn btn-outline-success" style="float: right">ID로 검색</button>
      	<input type="text" class="btn btn-outline-success" style="float: right">
