...
<div class="row d-lg-none d-block py-3">
	<div class="row d-flex justify-content-around align-items-center mx-auto">
		<input type="button" class="btn btn-primary col" value="이벤트" style="border: 1px solid gray;">
		<input type="button" class="btn btn-primary col" value="공지사항" style="border: 1px solid gray;">
		<input type="button" class="btn btn-primary col" value="에코게시판" style="border: 1px solid gray;">
	</div>
</div>
<!-- 모바일 탭 end -->